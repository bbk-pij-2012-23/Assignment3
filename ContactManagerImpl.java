...
public class ContactManagerImpl implements ContactManager  { /**
	...
	private Set<Contacts> allContacts;
	
//add meetings methods:
...
**/
	public int addFutureMeeting(Set<Contact> contacts, Calendar date){
		try { //need to look up the implementation of try methods again
			//create a new FutureMeeting(contacts, date);
			//identify a unique ID, call a setID(int id) Meeting method
				//how am I going to keep track of the ids created? see issue 5
			//add it to a List<FutureMeeting> futureMeetings
			return id;
		}catch(IllegalArgumentException ex){
			System.out.println("that date has passed. This meeting has not been created");
			printStackTrace(ex);
		}	
...
/**
* Returns the meeting with *
* @param id the ID for the
* @return the meeting with */
